  ...
  return (
    <div>
      <div className='flex  gap-4  mt-6'>
        ...
        <p className='px-8 py-2 text-sm gap-4 flex text-md cursor-pointer bg-white text-gray-700 font-semibold rounded-xl hover:bg-gray-100 transition-colors duration-300 border border-blue-200'>
