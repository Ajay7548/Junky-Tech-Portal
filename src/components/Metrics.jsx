...
const Metrics = ({title,desc,icon}) => {
  return (
    <div className='flex items-center   gap-2  justify-center flex-col'>
        <div className=' border-2 border-gray-100 dark:border-gray-950 dark:bg-blue-950  bg-blue-100  flex  rounded-full flex-col justify-center transition-all hover:duration-300
                hover:-translate-y-1
