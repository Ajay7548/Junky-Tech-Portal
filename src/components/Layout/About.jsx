    ...
    <div className=''>
      <div className='flex  gap-3 p-6 mt-8 mb-10 justify-center items-center'>
        ...
        <div className='rounded-xl '>
          <img src='/public/aboutimg.avif' className=' rounded-xl shadow-lg shadow-blue-200' alt='no img' />
        </div>

       

      </div>
       <div className="flex px-12 py-14 pt-16 bg-gray-100 w-full flex-col lg:flex-row items-center justify-between gap-6 ">
          ...
          <div className='flex pt-16 mt-10 mb-10 pb-20 flex-col items-center justify-center w-full  gap-5 '>
            ...
            <p className='text-gray-800 text-center max-w-4xl'>Founded in 2019, Junky Tech began with a simple mission: to bridge the gap between innovative technology and practical business solutions. What started as a small team of developers has grown into a full-service IT solutions company.</p>
            <p className='text-gray-800 text-center max-w-4xl'>Today, we're proud to serve clients across various industries, from startups looking to build their first digital product to established enterprises seeking digital transformation. Our diverse team brings together expertise in development, design, AI/ML, and cloud technologies.</p>
            <p className='text-gray-800 text-center max-w-4xl'>We believe that great technology should be accessible, reliable, and transformative. That's why we focus on building solutions that not only meet today's needs but are scalable for tomorrow's growth.</p>
          </div>

          <div className='flex flex-col justify-center items-center p-4 gap-6 mt-8  pb-8 bg-gray-100'>
          ...
          <p className="text-gray-800 text-lg text-center max-w-4xl mb-2">
