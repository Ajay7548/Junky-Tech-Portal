...
const Services = () => {
  ...
  return (
    <div className='flex bg-gray-50 flex-col min-h-screen  justify-baseline items-center  py-16  gap-2  px:2 lg:px-4 '>
      ...
      <div className='bg-gray-100 w-full mt-6  pb-16'>
        <HeadingComponent title={"Our Development Process"} desc={"A  proven methodology that ensures project success from concept to deployment"} />
         <div className='flex justify-between items-center gap-6 p-6 mt-4'>
           <div className='flex flex-col gap-3 justify-center items-center '>
            ...
            <p className='font-semibold text-gray-900 text-center  mt-2 text-lg'>Discovery & Planning</p>
          ...
          <div className='flex flex-col gap-3 justify-center items-center'>
            ...
            <p className='font-semibold text-gray-900 text-center  mt-2 text-lg'>Design & Prototype</p>
          ...
          <div className='flex flex-col gap-3 justify-center items-center'>
            ...
            <p className='font-semibold text-gray-900 text-center  mt-2 text-lg'>Development & Testing</p>
          ...
          <div className='flex flex-col gap-3 justify-center items-center'>
            ...
            <p className='font-semibold text-gray-900 text-center  mt-2 text-lg'>Deployment & Support</p>
